		...
		<div class="sidebar sidebar-style-2">			
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
                    ...
                    {{-- <li>
                      <a class="btn bg-gradient-primary mt-3" href="{{ url('logout') }}"
            onclick="event.preventDefault();
            document.getElementById('logout-form').submit();"><i class="fa fa-sign-out me-sm-1"></i>
            {{ __('Logout') }}
          </a>
          <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
            @csrf
					...
					<ul class="nav nav-primary">
						<li class="nav-item {{ request()->is('homeAnggota*') ? 'active' : '' }}">
							<a href="{{ url('/homeAnggota') }}" class="collapsed" aria-expanded="false">
						...
						<li class="nav-item {{ request()->is('dataAnggota*') ? 'active' : '' }}">
							<a  href="{{ route('dataAnggota.index') }}" data-active="1">
            ...
            {{-- <li class="nav-item {{ request()->is('jenisSimpanan*') ? 'active' : '' }} {{ request()->is('simpanan*') ? 'active' : '' }}">
							<a data-toggle="collapse" href="#jenisSimpanan">
								<i class="fas fa-wallet"></i>
								<p>Simpanan</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="jenisSimpanan">
								<ul class="nav nav-collapse">
									<li>
										<a href="{{ route('jenisSimpanan.index') }}">
											<span class="sub-item {{ (request()->is('jenisSimpanan*')) ? 'active' : '' }}">Jenis Simpanan Anggota</span>
										</a>
									</li>
									<li>
            ...
            <li class="nav-item {{ (request()->is('dataSimpanan*')) ? 'active' : '' }} {{ (request()->is('dataPenarikan*')) ? 'active' : '' }}">
							<a href="{{ route('dataSimpanan.index') }}">
								<i class="fas fa-wallet"></i>
								<p>Simpanan</p>
								{{-- <span class="caret"></span> --}}
							</a>
						...
						<li class="nav-item {{ (request()->is('dataPinjaman')) ? 'active' : '' }}">
							<a href="{{ route('dataPinjaman.index') }}">
						...
						<li class="nav-item {{ (request()->is('dataJasa*')) ? 'active' : '' }}">
							<a href="{{ route('dataJasa.index') }}">
            ...
            <li class="nav-item {{ (request()->is('dataSHU*')) ? 'active' : '' }}">
							<a href="{{ route('dataSHU.index') }}">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{ asset('img/talha.jpg" al') }}t="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
