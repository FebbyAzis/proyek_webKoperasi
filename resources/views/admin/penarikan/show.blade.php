                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 mt-1">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="addName" type="text" class="form-control" placeholder="Masukan Nominal Penarikan" name="jumlah">
                                    </div>
                                </div>
                                </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mt-3">
                            <div class="form-group form-group-default">
                                ...
                                $i['jumlah'] -= $total 
                            @endphp --}}
                                <input id="addName" type="text" class="form-control" placeholder="jumlah" name="jumlahSimpanan" value="{{$simpanan->jumlahSimpanan -= $total}}"><b>Rp. {{ number_format($simpanan->jumlahSimpanan, 0, ',', '.') }}</b>
                            </div>
                        </div>
