        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Jenis Pinjaman</h2>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h4 class="card-title">Tabel Data Jenis Pinjaman</h4>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="small">Lengkapi data dibawah ini untuk menambahkan jenis pinjaman baru!</p>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mt-1">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input id="addName" type="text" class="form-control" placeholder="nama Pinjaman" name="namaPinjaman">
                                        </div>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-button-action">
                                    ...
                                    <form action="{{ route('jenisPinjaman.destroy', $p->id) }}" method="post" class="mt-1">
                                        @csrf
                                        @method('DELETE')
                                    <button type="delete" data-toggle="" title="" class="btn btn-link btn-danger" data-original-title="Remove" data-target="{{('jenisPinjaman.destroy'. $p->id)}}" onclick="return confirm('Apakah anda yakin ingin menghapus data barang?')">
...
@foreach($data as $no => $p)
                ...
                <form action="{{ route('jenisPinjaman.update', $p->id)}}" method="post">
        @csrf
        @method('PUT')     
<div class="modal fade" id="addRowModal{{ $p->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="small">Ubah data dibawah ini untuk mengedit jenis pinjaman!</p>
                <form>
                    <div class="row">
                        <div class="col-sm-12 mt-1">
                            <div class="form-group form-group-default">
                                <label>Nama Pinjaman</label>
                                <input id="addName" type="text" class="form-control" placeholder="nama Pinjaman" name="namaPinjaman" value="{{ $p->namaPinjaman }}">
                            </div>
                        </div>
                    </div>
                </form>
