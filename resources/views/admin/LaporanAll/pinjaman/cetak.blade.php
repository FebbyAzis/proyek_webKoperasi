...
<head>
    ...
    <meta name="csrd-token" content="{{ csrf_token() }}">
        ...
        <br>
        <title class="mt-3">Laporan Pinjaman Anggota</title>
...
<body>
    <div class="form-group">
        ...
        <h1 align="center"><b>Laporan Pinjaman Anggota</b></h1>
        ...
        <table class="static" align="center" rules="all" border="1px" style="width: 90%;">
            ...
            <tr>
                ...
                <td align="end">&nbsp;Rp. {{ number_format($item['jumlahPinjaman'] ,0,',','.') }} &nbsp;</td>
            </tr>
            @endforeach
            <tfoot>
                <tr>
