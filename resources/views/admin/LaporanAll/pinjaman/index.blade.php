        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Data Laporan Pinjaman</h2>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h4 class="card-title">Form Data Laporan Pinjaman</h4>
            </div>
        </div>
        <div class="row">         
                <div class="card-body">
                    <div class="col-md-12">
                       ...
                       <div class="col-md-4 mb-3 mt-2">
                        <a href="" onclick="this.href='/cetakPinjaman/'+document.getElementById('tglawal').value+'/'+document.getElementById('tglakhir').value" target="_blank">
    ...
    <div class="card-header">
        <div class="d-flex align-items-center mb-3">
            <h4 class="card-title">Data Tabel Laporan Pinjaman</h4>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <form method="GET" action="/laporan-pinjaman-pertanggal">
            ...
            <div class="col-md-4 mt-3">
                    <button class="btn btn-secondary btn-sm btn-round ml-auto m-2" type="submit">
                        <i class="fas fa-search"></i>
                             &nbsp; Cari Pinjaman Berdasarkan Tanggal
                        </button>
                ...
                <table id="add-row" class="display table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ $item->jenisPinjaman->namaPinjaman}}</td>
                            <td>Rp. {{ number_format($item['jumlahPinjaman'] ,0,',','.') }}</td>
                        </tr>
                        @endforeach
