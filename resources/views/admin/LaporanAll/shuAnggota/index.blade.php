        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Data Laporan SHU Anggota</h2>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h4 class="card-title">Form Data Laporan SHU Anggota</h4>
            </div>
        </div>
        <div class="row">         
                <div class="card-body">
                    <div class="col-md-12">
                       ...
                       <div class="col-md-4 mb-3 mt-2">
                        <a href="" onclick="this.href='/cetak-shuAnggota/'+document.getElementById('tglawal').value+'/'+document.getElementById('tglakhir').value" target="_blank">
                           
                           <button class="btn btn-secondary btn-round ml-auto">
                            <i class="fas fa-print"></i>
                                 &nbsp; Cetak Laporan SHU Anggota
                            </button>
                        </a>
                       </div></div>
    ...
    <div class="card-header">
        <div class="d-flex align-items-center mb-3">
            <h4 class="card-title">Data Tabel Laporan SHU Anggota</h4>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <form method="GET" action="/laporan-shuAnggota-pertanggal">
            ...
            <div class="col-md-4 mt-3">
                    <button class="btn btn-secondary btn-sm btn-round ml-auto m-2" type="submit">
                        <i class="fas fa-search"></i>
                             &nbsp; Cari SHU Anggota Berdasarkan Tanggal
                        </button>
