...
<head>
    ...
    <meta name="csrd-token" content="{{ csrf_token() }}">
        ...
        <br>
        <title class="mt-3">Laporan SHU Anggota</title>
...
<body>
    <div class="form-group">
        ...
        <h1 align="center"><b>Laporan SHU Anggota</b></h1>
        ...
        <table class="static" align="center" rules="all" border="1px" style="width: 90%;">
            ...
            <tr>
                ...
                <td align="end">&nbsp;Rp. {{ number_format($item['simpanan'] ,0,',','.') }} &nbsp;</td>
                <td align="end">&nbsp;Rp. {{ number_format($item['hutang'] ,0,',','.') }} &nbsp;</td>
            </tr>
            @endforeach
            <tfoot>
                <tr>
