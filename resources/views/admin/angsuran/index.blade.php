                            ...
                            <td>{{ $bungareq }}</td> --}}
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <a href="{{ route('angsuran.show', $p->id) }}">
                                                        <button type="button" data-toggle="" title=""
                                                            class="btn btn-link btn-success btn-lg" data-original-title=""
                                                            data-target="{{ route('angsuran.show', $p->id) }}">
                                                            <i class="fa fa-eye"></i>
                                                        </button></a>
                                                    </form>
                                                    <form action="{{ route('angsuran.destroy', $p->id) }}" method="post"
                                                        class="mt-1">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="delete" data-toggle="" title=""
                                                            class="btn btn-link btn-danger" data-original-title="Remove"
                                                            data-target="{{ 'angsuran.destroy' . $p->id }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="exampleFormControlSelect1"
                                                    ...
                                                    @foreach ($pinjaman as $pinj)
                                                        <option value="{{ $pinj->id }}">{{ $pinj->users->name }} - {{ $pinj->jenispinjaman->namaPinjaman }}
                                                            {{-- @foreach ($data as $d)
                                      {{$d->users->name}}
                                    @endforeach --}}
                                                        </option>
...
{{-- 
                                        ...
                                        <div class="col-sm-12 mt-1">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input id="addName" type="text" class="form-control"
                                                    placeholder="angsuran" name="angsuran">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 mt-1">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input id="addName" type="date" class="form-control"
                                                    placeholder="tanggal bayar" name="tglBayar">
                                            </div>
                                        </div>
            ...
            @foreach ($data as $no => $p)
                <form action="{{ route('angsuran.update', $p->id) }}" method="post">
                    @csrf
                    @method('PUT')
