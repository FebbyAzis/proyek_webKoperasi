...
<body>
	<div class="wrapper">
		...
		<div class="sidebar sidebar-style-2">			
				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item {{ request()->is('anggota*') ? 'active' : '' }}">
							<a  href="{{ route('anggota.index') }}" data-active="1">
								<i class="fas fa-user"></i>
								<p>Anggota</p>
							</a>
						</li>
            <li class="nav-item {{ request()->is('jenisSimpanan*') ? 'active' : '' }} {{ request()->is('simpanan*') ? 'active' : '' }} {{ request()->is('penarikan*') ? 'active' : '' }}">
						...
						<li class="nav-item {{ request()->is('jenisPinjaman*') ? 'active' : '' }} {{ request()->is('pinjaman*') ? 'active' : '' }} {{ request()->is('angsuran*') ? 'active' : '' }}">
							<a data-toggle="collapse" href="#jenisPinjaman">
								<i class="fas fa-credit-card"></i>
								<p>Pinjaman</p>
								<span class="caret"></span>
							</a>
							<div class="collapse" id="jenisPinjaman">
								<ul class="nav nav-collapse">
									<li>
										<a href="{{ route('jenisPinjaman.index') }}">
											<span class="sub-item {{ (request()->is('jenisPinjaman*')) ? 'active' : '' }}">Jenis Pinjaman Anggota</span>
										</a>
									</li>
									<li>
						...
						<li class="nav-item {{ (request()->is('jasaAnggota*')) ? 'active' : '' }}">
							<a href="{{ route('jasaAnggota.index') }}">
            ...
            <li class="nav-item {{ (request()->is('shuAnggota*')) ? 'active' : '' }}">
							<a href="{{ route('shuAnggota.index') }}">
